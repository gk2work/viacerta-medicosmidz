  ...
  return (
    <footer className="tc-footer" id="contact">
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.4fr 1fr 1fr 1.4fr', gap: 48, maxWidth: 1320, margin: '0 auto' }}
          ...
          <div>
            <div className="footer-logo">
              <img src={`${BASE}/frontend/assets/img/logo/medicos_logo.png`} alt="MedicosMindz" />
            </div>
          ...
          <div>
            ...
            <div style={{ fontSize: 14, lineHeight: 2, opacity: 0.8, marginBottom: 28 }}>
              ...
              <p style={{ marginTop: 8 }}>
                ✉ <a href="mailto:medicosmindz@gmail.com">medicosmindz@gmail.com</a>
              </p>
            </div>
      ...
      <div className="footer-bottom">
        <span>© 2024 Medicosmindz. All Rights Reserved.</span>
